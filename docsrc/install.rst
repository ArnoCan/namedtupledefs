...
=========
   ...
   +==============+=============+===================================================+
   | Download     | PyPI        | https://pypi.python.org/pypi/namedtupledefs3      |
   +--------------+-------------+---------------------------------------------------+
   |              | Sourceforge | https://sourceforge.net/projects/namedtupledefs3/ |
   +--------------+-------------+---------------------------------------------------+
   |              | github.com  | https://github.com/ArnoCan/namedtupledefs3/       |
   +--------------+-------------+---------------------------------------------------+
   | Documents    | sourceforge | https://namedtupledefs3.sourceforge.io/           |
   +--------------+-------------+---------------------------------------------------+
...
Alternative:
   ...
   | prerequisite | reference   | description                                      |
   +==============+=============+==================================================+
   | Download     | PyPI        | https://pypi.python.org/pypi/namedtupledefs      |
   +--------------+-------------+--------------------------------------------------+
   |              | Sourceforge | https://sourceforge.net/projects/namedtupledefs/ |
   +--------------+-------------+--------------------------------------------------+
   |              | github.com  | https://github.com/ArnoCan/namedtupledefs/       |
   +--------------+-------------+--------------------------------------------------+
   | Documents    | sourceforge | https://namedtupledefs.sourceforge.io/           |
   +--------------+-------------+--------------------------------------------------+
...
Install from PyPI.org by calling:
   ...
   .. parsed-literal::
      ...
      pip install namedtupledefs3
      pip install namedtupledefs

Once installed any supported implementation will work.

The runtime package is distinct from the source package, which is also called the SDK - Sofware 
Developemnt Kit.
...
=============
   ...
   | prerequisite | reference                | description                                                |
   +==============+==========================+============================================================+
   | Runtime      | Python Syntax            | Python3.5+                                                 |
   +--------------+--------------------------+------------------------------------------------------------+
   |              | Python Distributions     | CPython, PyPy, IPython                                     |
   +              +                          +                                                            +
   ...
   +--------------+--------------------------+------------------------------------------------------------+
   | Packages     | Python                   | pyfilesysobjects, pyplatformids, pythonids                 |
   |              |                          | (jsonschema), (ujson/ultrajson)                            |
   +--------------+--------------------------+------------------------------------------------------------+
   |              | Cygwin                   | cygwinreg                                                  |
   +              +--------------------------+------------------------------------------------------------+
   | SDK          | Python                   | CPython 3.5+                                               |
   +--------------+--------------------------+------------------------------------------------------------+
   |              | bash                     | bash-4.x                                                   |
   +              +--------------------------+------------------------------------------------------------+
...
The tested Python implementations on the supported OS on standard platforms are:
   ...
   | Windows10Home           | \*        | --      | --         | --        | --   | --         |
   +-------------------------+-----------+---------+------------+-----------+------+------------+
   | Windows10Professional   | OK        | OK      | --         | --        | OK   | \*         |
   +-------------------------+-----------+---------+------------+-----------+------+------------+
   | Windows2008             | \*        | --      | --         | --        | --   | --         |
   +-------------------------+-----------+---------+------------+-----------+------+------------+
   | Windows2008R2           | \*        | --      | --         | --        | --   | --         |
